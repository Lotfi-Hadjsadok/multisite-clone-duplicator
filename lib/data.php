    ...
    class MUCD_Data
    {
        ...
        public static function db_copy_tables($from_site_id, $to_site_id)
        {
            ...
            if ($from_site_id == MUCD_PRIMARY_SITE_ID) {
                ...
                global $wpdb; // Ensure you're using the global $wpdb object

                // Define the primary WordPress database schema name if not already set
                $schema = $wpdb->dbname; // This ensures it's targeting the primary database
            ...
            if (is_array($fields) || !empty($fields)) {
                ...
                foreach ($fields as $field) {
                    ...
                    if (in_array($field_type, array(
                        ...
                        // Use LIKE pattern for other types
                        $value = '%' . $from_string_like . '%';
                    }

                    // Prepare the SQL query based on the adjusted value
